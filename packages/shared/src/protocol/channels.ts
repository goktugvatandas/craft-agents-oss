...
export const RPC_CHANNELS = {
  ...
  remoteServers: {
    ...
    SAVE_TOKEN: 'remoteServers:saveToken',
    CLEAR_TOKEN: 'remoteServers:clearToken',
    GET_AUTH_MATERIAL: 'remoteServers:getAuthMaterial',
    CHANGED: 'remoteServers:changed',
  },
  window: {
  ...
  llmConnections: {
    ...
    EXPORT_BUNDLE: 'LLM_Connection:exportBundle',
    IMPORT_BUNDLE: 'LLM_Connection:importBundle',
  ...
  sources: {
    ...
    EXPORT_BUNDLE: 'sources:exportBundle',
    IMPORT_BUNDLE: 'sources:importBundle',
  ...
  skills: {
    ...
    EXPORT_BUNDLE: 'skills:exportBundle',
    IMPORT_BUNDLE: 'skills:importBundle',
