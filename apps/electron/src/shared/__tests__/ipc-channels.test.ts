...
const EXPECTED_CHANNELS: string[] = [
  ...
  'LLM_Connection:exportBundle',
  'LLM_Connection:get',
  'LLM_Connection:getApiKey',
  'LLM_Connection:importBundle',
  'LLM_Connection:list',
  ...
  'remoteServers:changed',
  'remoteServers:clearToken',
  'remoteServers:delete',
  'remoteServers:getAuthMaterial',
  'remoteServers:list',
  'remoteServers:save',
  'remoteServers:saveToken',
  'session:event',
  'session:getModel',
  'session:setModel',
  'sessions:cancel',
  ...
  'sessions:getNotes',
  'sessions:getPendingPermissions',
  ...
  'sources:create',
  'sources:delete',
  'sources:exportBundle',
  'sources:get',
  'sources:getMcpTools',
  'sources:getPermissions',
  'sources:importBundle',
